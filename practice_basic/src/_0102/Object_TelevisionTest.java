...
*/
public class Object_TelevisionTest {
	public static void main(String[] args) {
		...
		//그래서 생성자를 만들어준 것
		//메소드를 따로 호출하지 않고, 
		Object_Television[] tv = new Object_Television[3];
		tv[0] = new Object_Television(7);
		tv[1] = new Object_Television(9);
		tv[2] = new Object_Television(11);
