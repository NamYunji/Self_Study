...
public class Object_Pizza {
	...
	// parameter생성자
	public Object_Pizza(String brand, double diameter, int price) {
		super();
		this.brand = brand;
		this.diameter = diameter;
		this.price = price;
	...
	public Object_Pizza(String brand) {
		super();
		this.brand = brand;
	}
	...
	public Object_Pizza(String brand, double diameter) {
		super();
		this.brand = brand;
		this.diameter = diameter;
	}
